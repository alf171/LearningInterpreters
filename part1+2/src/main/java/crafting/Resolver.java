...
/**
 * Since we need to visit all nodes on syntax tree, implement our visitor
 * abstraction.
 */
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    public Resolver(Interpreter interpreter) {
        ...
        this.scopes = new Stack<Map<String, Boolean>>();
    }
    ...
    // all interesting ones above. these are just so that we traverse tree properly
    ...
    public Void visitThisExpr(Expr.This expr) {
        if (currentClass == ClassType.NONE) {
            Lox.error(expr.keyword, "Cnat use 'this' outside of a class");
        }
